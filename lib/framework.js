...
class Framework {
	...
	initScriptMode(config) {
		...
		const url = config.ui5.url ? config.ui5.url : `${config.protocol}//${config.hostname}:${config.port}/base/webapp`;
		...
		config.files.unshift(this.createPluginFilesPattern(`${url}/resources/sap-ui-core.js`));
