...
class Framework {
	...
	init(config) {
		...
		// Add plugin adapter and third-party dependencies
		this.config.files.unshift(this.createPluginFilesPattern(__dirname + "/adapter.js"));
		this.config.files.unshift(this.createPluginFilesPattern(__dirname + "/../dist/istanbul-lib-coverage.js"));
