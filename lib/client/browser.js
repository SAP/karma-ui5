				...
				windowUtil(qunitHtmlFile, function(testWindow) {
					...
					QUnit.log(function(details) {
						...
						if (config.logAssertions) {
							const testSuite = [details.module, details.name, details.message];
							const testSuiteWithHTMLFilePath = testSuite.unshift(qunitHtmlFile) && testSuite;
							const result = {
