...
const CustomFilesReporter = function(baseReporterDecorator, config, logger, helper) {
	const log = logger.create("reporter.customFiles");
	const reporterConfig = config.customFilesReporter || {};
